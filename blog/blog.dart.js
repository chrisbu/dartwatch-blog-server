...
// ********** Code for HashMapImplementation_dart_core_String$DoubleLinkedQueueEntry_KeyValuePair_dart_core_String$dart_core_String **************
$inherits(HashMapImplementation_dart_core_String$DoubleLinkedQueueEntry_KeyValuePair_dart_core_String$dart_core_String, HashMapImplementation);
function HashMapImplementation_dart_core_String$DoubleLinkedQueueEntry_KeyValuePair_dart_core_String$dart_core_String() {
  this._numberOfEntries = (0);
  this._numberOfDeleted = (0);
  this._loadLimit = HashMapImplementation._computeLoadLimit((8));
  this._keys = new Array((8));
...
HashMapImplementation_dart_core_String$DoubleLinkedQueueEntry_KeyValuePair_dart_core_String$dart_core_String.prototype.is$Map = function(){return true};
HashMapImplementation_dart_core_String$DoubleLinkedQueueEntry_KeyValuePair_dart_core_String$dart_core_String.prototype.is$Map_dart_core_String$Dynamic = function(){return true};
...
// ********** Code for LinkedHashMapImplementation_dart_core_String$dart_core_String **************
$inherits(LinkedHashMapImplementation_dart_core_String$dart_core_String, LinkedHashMapImplementation);
function LinkedHashMapImplementation_dart_core_String$dart_core_String() {
  this._map = new HashMapImplementation_dart_core_String$DoubleLinkedQueueEntry_KeyValuePair_dart_core_String$dart_core_String();
  this._list = new DoubleLinkedQueue_KeyValuePair_dart_core_String$dart_core_String();
}
LinkedHashMapImplementation_dart_core_String$dart_core_String.prototype.is$Map = function(){return true};
LinkedHashMapImplementation_dart_core_String$dart_core_String.prototype.is$Map_dart_core_String$Dynamic = function(){return true};
// ********** Code for Maps **************
function Maps() {}
...
// ********** Code for DoubleLinkedQueueEntry_KeyValuePair_dart_core_String$dart_core_String **************
$inherits(DoubleLinkedQueueEntry_KeyValuePair_dart_core_String$dart_core_String, DoubleLinkedQueueEntry);
function DoubleLinkedQueueEntry_KeyValuePair_dart_core_String$dart_core_String(e) {
  this._element = e;
}
...
// ********** Code for _DoubleLinkedQueueEntrySentinel_KeyValuePair_dart_core_String$dart_core_String **************
$inherits(_DoubleLinkedQueueEntrySentinel_KeyValuePair_dart_core_String$dart_core_String, _DoubleLinkedQueueEntrySentinel);
function _DoubleLinkedQueueEntrySentinel_KeyValuePair_dart_core_String$dart_core_String() {
  DoubleLinkedQueueEntry_KeyValuePair_dart_core_String$dart_core_String.call(this, null);
  this._link(this, this);
}
...
// ********** Code for DoubleLinkedQueue_KeyValuePair_dart_core_String$dart_core_String **************
$inherits(DoubleLinkedQueue_KeyValuePair_dart_core_String$dart_core_String, DoubleLinkedQueue);
function DoubleLinkedQueue_KeyValuePair_dart_core_String$dart_core_String() {
  this._sentinel = new _DoubleLinkedQueueEntrySentinel_KeyValuePair_dart_core_String$dart_core_String();
}
DoubleLinkedQueue_KeyValuePair_dart_core_String$dart_core_String.prototype.is$Collection = function(){return true};
...
//  ********** Library C:\Users\chrisbu\dart\dartwatch-blog-server\blog\blog **************
// ********** Code for top level **************
function main() {
  var input = _ElementFactoryProvider.Element$tag$factory("textarea");
  get$$document().get$body().get$nodes().add(input);
  var button = _ElementFactoryProvider.Element$tag$factory("button");
  get$$document().get$body().get$nodes().add(button);
  var postDiv = _ElementFactoryProvider.Element$tag$factory("div");
  get$$document().get$body().get$nodes().add(postDiv);
  button.get$on().get$click().add$1((function (event) {
    var req = _XMLHttpRequestFactoryProvider.XMLHttpRequest$factory();
    req.open("POST", "http://localhost:8083/post");
    var blogPost = new LinkedHashMapImplementation_dart_core_String$dart_core_String();
    blogPost.$setindex("text", input.get$value());
    blogPost.$setindex("posted", new DateImplementation.now$ctor().toString());
    var jsonData = json_JSON.stringify(blogPost);
    addPostToUi(postDiv, blogPost);
    req.send(jsonData);
  })
  );
  var req = _XMLHttpRequestFactoryProvider.XMLHttpRequest$getTEMPNAME$factory("http://localhost:8083/post/all", (function (result) {
...
function addPostToUi(postDiv, blogPost) {
  var postedDate = _ElementFactoryProvider.Element$tag$factory("div");
  postedDate.set$innerHTML(blogPost.$index("posted"));
  var postText = _ElementFactoryProvider.Element$tag$factory("div");
  postText.get$nodes().add(postedDate);
  postText.get$nodes().add(_ElementFactoryProvider.Element$html$factory(("<span>" + blogPost.$index("text") + "</span>")));
  postDiv.get$nodes().add(postText);
}
// 213 dynamic types.
// 230 types
// 22 !leaf
